...
int main() {
    ...
    params.volume = 0.0116;        // B = 1025 * 9.80665 * 0.0116 = 116.601 N (slightly positive)
    params.fluid_density = 1025.0;
    params.gravity = 9.80665;
    params.r_G = nav_dynamics::Vector3d(0.0, 0.0, 0.02);  // CoG below origin (NED +z)
    params.r_B = nav_dynamics::Vector3d(0.0, 0.0, -0.02); // CoB above origin (NED -z)
    ...
    // 1. Level Orientation (phi = theta = psi = 0)
    ...
    // 3. Roll Tilt Stability (phi = 10 deg)
